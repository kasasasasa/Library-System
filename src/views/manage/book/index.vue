<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="bookList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="书籍封面" align="center" prop="cover" width="100">
        <template #default="scope">
          <image-preview :src="scope.row.cover" :width="50" :height="50"/>
        </template>
      </el-table-column>
      <el-table-column label="书籍作者" align="center" prop="author" />
      <el-table-column label="书籍出版社" align="center" prop="publisher" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="bookRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="书籍出版社" prop="publisher">
          <el-input v-model="form.publisher" placeholder="请输入书籍出版社" />
        </el-form-item>
...
const data = reactive({
  ...
  rules: {
    ...
    publisher: [
      { required: true, message: "书籍出版社不能为空", trigger: "blur" }
    ],
    publishDate: [
